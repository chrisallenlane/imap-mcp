...
func TestMoveMessages_Description(t *testing.T) {
	tool := NewMoveMessages(&mockMover{})
...
func TestMoveMessages_InputSchema(t *testing.T) {
	tool := NewMoveMessages(&mockMover{})
...
func TestMoveMessages_Success(t *testing.T) {
	mock := &mockMover{}
...
func TestMoveMessages_MissingAccount(t *testing.T) {
	mock := &mockMover{}
	tool := NewMoveMessages(mock)
...
func TestMoveMessages_MissingMailbox(t *testing.T) {
	mock := &mockMover{}
	tool := NewMoveMessages(mock)
...
func TestMoveMessages_MissingDestination(t *testing.T) {
	mock := &mockMover{}
	tool := NewMoveMessages(mock)
...
func TestMoveMessages_DestinationEqualsSource(
	t *testing.T,
) {
	mock := &mockMover{}
	tool := NewMoveMessages(mock)
...
func TestMoveMessages_InvalidJSON(t *testing.T) {
	mock := &mockMover{}
	tool := NewMoveMessages(mock)
...
func TestMoveMessages_MoveError(t *testing.T) {
	mock := &mockMover{
