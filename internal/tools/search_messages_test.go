...
func TestSearchMessages_FlaggedTrue(t *testing.T) {
	mock := &mockMessageSearcher{
		uids: []imap.UID{1},
		messages: []*imapclient.FetchMessageBuffer{
			{
	...
	assertContains(t, result, "Flagged msg")
}

func TestSearchMessages_FlaggedFalse(t *testing.T) {
	mock := &mockMessageSearcher{
		uids: []imap.UID{1},
		messages: []*imapclient.FetchMessageBuffer{
			{
	...
	assertContains(t, result, "Unflagged msg")
}

func TestSearchMessages_SeenTrue(t *testing.T) {
	mock := &mockMessageSearcher{
		uids: []imap.UID{1},
		messages: []*imapclient.FetchMessageBuffer{
			{
	...
	assertContains(t, result, "Seen msg")
}

func TestSearchMessages_SeenFalse(t *testing.T) {
	mock := &mockMessageSearcher{
		uids: []imap.UID{1},
		messages: []*imapclient.FetchMessageBuffer{
			{
	...
	assertContains(t, result, "Unseen msg")
}
